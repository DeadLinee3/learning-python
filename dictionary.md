...
| ---------------- | -------------------------------------------------------------------------------- | ---------------------------------- | ------------------ |
| `print()`        | **Вывод данных** на экран — текста, чисел, результата вычислений или переменных. | `print("Привет")`                  | Привет             |
| `input()`        | **Ввод данных** от пользователя. Всегда возвращает строку (текст).               | `name = input("Как тебя зовут? ")` | Вводишь → `Василь` |
| `int()`          | Преобразует **строку в целое число** для вычислений.                             | `int("5")` → `5`                   | Число 5            |
| `float()`        | Преобразует **строку в число с точкой**.                                         | `float("3.14")` → `3.14`           | Число 3.14         |
